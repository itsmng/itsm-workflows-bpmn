            ...
            if (sessionResponse.status === 200 && sessionResponse.data && sessionResponse.data.session_token) {
                ...
                const payload = {
                    input: {
                        ...
                        status: ticketContent.status || 1,
                        entities_id: ticketContent.entities_id ?? 0,
                        itilcategories_id: ticketContent.itilcategories_id || null,
                        requesttypes_id: ticketContent.requesttypes_id || null,
                        locations_id: ticketContent.locations_id || null,
                        urgency: ticketContent.urgency || 3,
                        impact: ticketContent.impact || 3,
